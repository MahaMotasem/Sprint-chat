          ...
          return Container(
            ...
            child: Scaffold(
              ...
              appBar: AppBar(
                ...
                actions: [
                  IconButton(
                      onPressed: () {}, icon: const Icon(Icons.video_call,color: Colors.white54,)),
                  IconButton(onPressed: () {}, icon: const Icon(Icons.phone,color: Colors.white54)),
                  IconButton(
                      onPressed: () {}, icon: const Icon(Icons.more_vert,color: Colors.white54)),
                ],
              ),
              body: Padding(
                          ...
                          child: TextField(
                           style: TextStyle(color: Colors.white),
                            ...
                            decoration: InputDecoration(
                              ...
                              suffixIcon: const Icon(Icons.camera_alt,color: Colors.white54),
                              filled: true,
